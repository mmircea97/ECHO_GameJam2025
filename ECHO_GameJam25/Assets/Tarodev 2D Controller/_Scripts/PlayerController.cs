...
namespace TarodevController
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        private void Update()
        {
            ...
            {
                _rb.transform.Translate(0f, _stats.ClimbSpeed, 0f);
                if (Keyboard.current.spaceKey.wasPressedThisFrame)
                {
                    _jumpToConsume = true;
                    ExecuteJump();
            ...
            if (isHanging && Keyboard.current.sKey.isPressed)
            {
                _rb.transform.Translate(0f, -_stats.ClimbSpeed, 0f);
                if (Keyboard.current.spaceKey.wasPressedThisFrame)
                {
            ...
            if (isHanging && Keyboard.current.spaceKey.wasPressedThisFrame)                                     
            {
        ...
        private void ExecuteBounce()
        {
            ...
            _bufferedJumpUsable = false;
            _coyoteUsable = false;
            _frameVelocity.y = _stats.JumpPower * _stats.BumpinessMultilpier;
            Jumped?.Invoke();
        }
