...
namespace TarodevController
{
    ...
    public class ScriptableStats : ScriptableObject
    {
        ...
        [Tooltip("The bounciness multiplier of the jump when jumping on a spring")]
        public float BumpinessMultilpier = 3f;

        [Tooltip("The speed at which the player climbs platforms when hanging")]
        public float ClimbSpeed = 0.02f;
        
        [Tooltip("Speed at which the player slides down when hanging on a ledge")]
        public float SlideSpeed = 0.02f;
